...
class CommonPlatform ():
    PackagesSupported = ("sagitkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('sagit', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "sagit", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "sagitPkg/sagit.dsc", "Platform Hardcoded")
